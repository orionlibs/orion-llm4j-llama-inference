...
/**
 * {@link SimpleFloatTensor} quantized in the {@link GGUFType#Q4_0} format.
 * <p>
 * This tensor implementation is not compatible with {@link SimpleFloatTensor}, but
 * {@link #dot(int, FloatTensor, int, int)} has a vectorized implementation that is used when
 * the second argument implements {@link SimpleFloatTensor}.
 */
public final class Q4_0SimpleFloatTensor extends SimpleFloatTensor
{
    final int size;
    final MemorySegment memorySegment;


    public Q4_0SimpleFloatTensor(int size, MemorySegment memorySegment)
    {
        this.size = size;
    ...
    private static float vectorDot(Q4_0SimpleFloatTensor thiz, int thisOffset, FloatTensor that, int thatOffset, int size)
    {
        float result = 0f;
        int j = 0;
